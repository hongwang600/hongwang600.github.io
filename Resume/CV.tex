...
\Entry
I am currently working on information extraction and reasoning over knowledge graph, especially for lifelong learning and few-shot learning settings. I am also interested in open-domain question answering, pre-training methods with self-supervised learning, and low resource Natural Language Processing such as transferring knowledge from rich resource language to another low resource language. 
